...
public static class EntityHelper {
  ...
  // public static ReadOnlySpan<NekoScript> GetScripts(this List<Entity> entities) {
  //   var list = new List<NekoScript>();
  ...
  // public static ReadOnlySpan<NekoScript> GetScriptsAsSpan(this Entity[] entities) {
  //   var list = new List<NekoScript>();
  ...
  // public static NekoScript[] GetScriptsAsArray(this Entity[] entities) {
  //   var list = new List<NekoScript>();

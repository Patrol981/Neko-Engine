...
public class Entity {
  ...
  // public T GetScript<T>() where T : NekoScript {
  //   if (CanBeDisposed) throw new ArgumentException("Cannot access disposed entity!");
  //   return _componentManager.GetComponent<T>();
  // }

  // public NekoScript[] GetScripts() {
  //   lock (_componentLock) {
  //     if (CanBeDisposed) {
  //       return [];
  //     }
  ...
  //       var t = typeof(NekoScript).IsAssignableFrom(item.Key);
  //       if (t) {
  //         var value = item.Value;
  //         list.Add((NekoScript)value);
  //       }
  //     }
  ...
  //   foreach (var script in scripts) {
  //     clone.AddComponent((NekoScript)script.Clone());
  //   }

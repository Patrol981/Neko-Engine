...
// public class Render3DSystem_ : SystemBase, IRenderSystem {
...
//   private NekoBuffer _modelBuffer = null!;
//   private NekoBuffer _complexVertexBuffer = null!;
//   private NekoBuffer _complexIndexBuffer = null!;
...
//   // private readonly NekoBuffer _indirectCommandBuffer = null!;
...
//     _complexVertexBuffer = new NekoBuffer(
//       _allocator,
//       _device,
//       (ulong)Unsafe.SizeOf<Vertex>(),
//       vtxCount,
...
//     _complexIndexBuffer = new NekoBuffer(
//       _allocator,
//       _device,
//       sizeof(uint),
//       idxCount,

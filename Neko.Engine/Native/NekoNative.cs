...
/// <summary>
/// This is an AOT wrapper for NekoEngine, you don't need to use it if you are not using AOT linking
/// </summary>
public static partial class NekoNativeInterop {
  #region Application

  [UnmanagedCallersOnly(EntryPoint = "Neko_CreateApplication")]
  public static int Application_CreateApplication(IntPtr pAppName, int sizeX, int sizeY, int iVsync, int iFullscreen) {
    Logger.Info("Neko_CreateApplication called");
    ...
    var systemConfiguration = new SystemConfiguration() {
      PhysiscsBackend = Neko.Physics.Backends.BackendKind.Jolt
    };
    try {
  ...
  [UnmanagedCallersOnly(EntryPoint = "Neko_GetApplication")]
  public static IntPtr Application_GetApplication() {
    return (nint)Application.Instance;
  }

  [UnmanagedCallersOnly(EntryPoint = "Neko_SetUpdateCallback")]
  public static void Application_SetUpdateCallback() { }

  [UnmanagedCallersOnly(EntryPoint = "Neko_SetRenderCallback")]
  public static void Application_SetRenderCallback() { }

  [UnmanagedCallersOnly(EntryPoint = "Neko_SetGUICallback")]
  public static void Application_SetGUICallback() { }

  [UnmanagedCallersOnly(EntryPoint = "Neko_SetAppLoaderCallback")]
  public static void Application_SetAppLoaderCallback() { }

  [UnmanagedCallersOnly(EntryPoint = "Neko_SetOnLoadPrimaryCallback")]
  public static void Application_SetOnLoadPrimaryCallback() { }

  [UnmanagedCallersOnly(EntryPoint = "Neko_SetOnLoadCallback")]
  public static void Application_SetOnLoadCallback() { }

  [UnmanagedCallersOnly(EntryPoint = "Neko_CloseApp")]
  public static void Application_CloseApp() { }

  [UnmanagedCallersOnly(EntryPoint = "Neko_SetCurrentScene")]
  ...
  [UnmanagedCallersOnly(EntryPoint = "Neko_Run")]
  ...
  [UnmanagedCallersOnly(EntryPoint = "Neko_Scene_CreateScene")]
  ...
  [UnmanagedCallersOnly(EntryPoint = "Neko_Scene_AddEntity")]
  ...
  [UnmanagedCallersOnly(EntryPoint = "Neko_Entity_AddTransform")]
  ...
  [UnmanagedCallersOnly(EntryPoint = "Neko_Entity_AddMaterial")]
  ...
  [UnmanagedCallersOnly(EntryPoint = "Neko_Entity_AddPrimitive")]
